...
export const INITIAL_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    text: 'Dr. Vaishnavi Sahu is incredibly professional. I visited for cystic acne scars that I had for years. After 3 laser sessions at The Skin Health Clinic, the scars have flattened significantly. The clinic in Kidwai Nagar is very hygiene-focused and uses extremely advanced machinery. Strongly recommended!',
    date: '2026-04-18',
    source: 'Google Maps',
  ...
  },
  {
    ...
    author: 'Sneha Gupta',
    rating: 5,
    text: 'I had the most wonderful HydraFacial and skin treatment here. Dr. Vaishnavi is extremely patient; she analyzed my core skin barrier before recommending anything. Unlike other places, they don\'t force you to buy unnecessary products. The clinic architecture is very soothing and calm!',
    date: '2026-05-02',
  ...
  },
  {
    ...
    author: 'Rajesh Verma',
    rating: 5,
    text: 'Highly satisfied with the skin allergy clinic services. I was struggling with chronic eczema on my hands. Dr. Vaishnavi identified the allergen trigger on the very first visit. Her prescribed regime worked wonders in a single week.',
    date: '2026-05-24',
    source: 'Google Maps',
  ...
  },
  {
    ...
    rating: 5,
    text: 'Undoubtedly the best skin clinic in Kidwai Nagar / Kanpur area. The entire staff is professional, the atmosphere is elegant, and Dr. Sahu is a true expert. My skin texture has never felt better after the anti-aging therapy.',
    date: '2026-06-01',
    source: 'Google Maps',
    role: 'Local Guide',
